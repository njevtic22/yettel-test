...
## Napomena
U rešenju nije implementirana authentikacija i autorizacija, te samim tim svaki korisnik može da lista sve druge korisnike i da menja njihove podatke i da lista i menja sve taskove (čak i one koje nije kreirao).
